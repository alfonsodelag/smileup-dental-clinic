export const posts = [
  {
    title: "¿Qué es un diseño de sonrisa natural?",
    excerpt:
  ...
  {
    title: "Blanqueamiento dental: qué debes saber antes de hacerlo",
    excerpt:
  ...
  {
    title: "Bruxismo: señales de que podrías estar desgastando tus dientes",
    excerpt:
